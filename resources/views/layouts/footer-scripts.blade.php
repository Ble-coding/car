  ...
  <script src="{{URL::asset('assets/js/jquery.repeater.min30da.js?id=422a9663b1a9c0ff6e34')}}"></script>
  <script src="{{URL::asset('assets/js/form-repeaterc45d.js?id=0096e49afc7ced71346d')}}"></script>
